...
public class RNBLEModule extends ReactContextBaseJavaModule{
    ...
    private Callback onReadCharacteristics;
    // private Callback callback;
    // private Callback callback;
    // private Callback callback;
    // private Callback callback;
   ...
   private void onConnected(String session) {
    ...
    // Put data to map
    payload.putString("sessionId", session);
  ...
  this.reactContext
   ...
   private void onWriteCharacter(String chars) {
    // Create map for params
    WritableMap payload = Arguments.createMap();
    // Put data to map
    payload.putString("chars", chars);
    // Get EventEmitter from context and send event thanks to it
  this.reactContext
    .getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
    .emit("onWriteResponse", payload);
}
    @Override
    ...
    private final BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device, int requestId,
            ...
            onWriteCharacter(new String(value, StandardCharsets.UTF_8));
